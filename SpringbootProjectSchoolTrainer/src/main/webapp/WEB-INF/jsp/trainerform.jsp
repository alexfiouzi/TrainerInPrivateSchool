        ...
        <div class="container bg-light">
            <springform:form action="doinserttrainer" method="post" modelAttribute="newtrainer">
                        ...
                        <div class="form-group">
                            ...
                            <springform:input type="number"  path="age" cssClass="form-control" id="age" placeholder="trainer's age"  required="true" aria-describedby="pwdhelp2"/>
                            <springform:errors path="age" cssClass="error"/>
                            <small id="pwdhelp2" class="form-text text-muted">Warning use only Numbers</small>
                        </div>
                        <input type="submit" name=”submit” value="Add Trainer">  <input type="reset" name=”reset” value=Reset>
                        </springform:form>
                    </div>
